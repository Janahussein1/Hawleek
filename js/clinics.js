document.addEventListener("DOMContentLoaded", () => {
    ...
    bookLinks.forEach(link => {
        link.addEventListener('click', (e) => {
            // Only handle custom modal booking if user clicked on static list in clinics page
            if (window.location.pathname.includes('/clinics') && !document.getElementById('clinic-list')) {
                e.preventDefault(); 
